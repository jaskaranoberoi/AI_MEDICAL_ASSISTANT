...
**CONTEXT AND ROLE**  
Act as an experienced Senior Full-Stack AI Engineer, AI Application Architect, and Healthcare Software Developer.

Your task is to build a production-ready AI Medical Assistant Platform that combines:
...
The system should feel like a modern healthcare AI copilot while remaining safe, privacy-focused, modular, and scalable.
...
\- Beginner-friendly but production-style code
...
The final system should work as a production-style AI Medical Assistant Platform with:
